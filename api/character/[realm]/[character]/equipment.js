// Individual route: /api/character/[realm]/[character]/equipment.js
export default async function handler(req, res) {
  ...
  try {
    ...
    const apiUrl = `https://us.api.blizzard.com/profile/wow/character/${realm}/${character}/equipment?namespace=profile-classic-us&locale=en_US`;
