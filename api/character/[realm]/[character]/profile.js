// Individual route: /api/character/[realm]/[character]/profile.js
export default async function handler(req, res) {
  const { realm, character } = req.query;

  console.log('Character profile API called:', {
    method: req.method,
    url: req.url,
    query: req.query,
    realm,
  ...
  try {
    ...
    const apiUrl = `https://us.api.blizzard.com/profile/wow/character/${realm}/${character}?namespace=profile-classic-us&locale=en_US`;
