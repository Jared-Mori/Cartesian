// Individual route: /api/guild/[realm]/[guild]/activity.js
export default async function handler(req, res) {
  const { realm, guild } = req.query;

  console.log('Guild activity API called:', {
    method: req.method,
    url: req.url,
    query: req.query,
    realm,
  ...
  try {
    ...
    const apiUrl = `https://us.api.blizzard.com/data/wow/guild/${realm}/${encodeURIComponent(guild)}/activity?namespace=profile-classic-us&locale=en_US`;
